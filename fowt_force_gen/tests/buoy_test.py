...
class WebGeneralParseTest:
    def web_general_parse_test_1(self):
    ...
    def web_general_parse_test_2(self):
    ...
    def web_general_parse_test_3(self):
...
class WebDataParseTest:
    def web_data_parse_test_1(self):
