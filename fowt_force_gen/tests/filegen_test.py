...
class BulkFileTest:
    ...
    def bulk_file_test_2(self):
        # inflowwind bulk filegen with two test files
        template_file = '../core/template_files/InflowWind_template.dat'
        ...
        compare_file1 = 'test_fast/compare_inflowwind_10mps_0deg.dat'
        compare_file2 = 'test_fast/compare_inflowwind_10mps_180deg.dat'
        compare_file3 = 'test_fast/compare_inflowwind_11.4mps_0deg.dat'
        compare_file4 = 'test_fast/compare_inflowwind_11.4mps_180deg.dat'
        directions = [0, 180]
        filegen.inflowwind_bulk_filegen(template_file, new_file_root, 'test_fast', directions)
        assert os.path.isfile(expected_file1)
        assert os.path.isfile(expected_file2)
    ...
    def bulk_file_test_3(self):
        # hydrodyn_bulk_filegen for given water depth, wave climate, and current climate
        template_file = '../core/template_files/OC4Semi_HydroDyn_template.dat'
        new_file_root = 'test_hd'
        expected_file1 = 'test_hd_Climate0.dat'
        expected_file2 = 'test_hd_Climate1.dat'
        compare_file1 = 'test_fast/compare_hydrodyn_Climate0.dat'
        compare_file2 = 'test_fast/compare_hydrodyn_Climate1.dat'
        water_depth = '200'
    ...
    def bulk_file_test_5(self):
        # fst_bulk_filegen for two test files
        template_file = '../core/template_files/OC4Semi_OpenFAST_template.fst'
        new_file_root = 'test_fst'
        moordyn_file = 'test_fast/compare_md_file_1.dat'
        ifw_file_dir = 'test_fast/test_fst_bulk'
        hd_file_dir = 'test_fast/test_fst_bulk'
        ...
        compare_file1 = 'test_fast/compare_fst_bulk_10mps_0deg_Climate0.fst'
        compare_file2 = 'test_fast/compare_fst_bulk_10mps_0deg_Climate1.fst'
        compare_file3 = 'test_fast/compare_fst_bulk_11.4mps_180deg_Climate0.fst'
        compare_file4 = 'test_fast/compare_fst_bulk_11.4mps_180deg_Climate1.fst'
